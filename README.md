...
`/Training` is a copy of the files in `/src` altered to become training code and training data used by `modal_test.py` to train and update `model_weights.pt` is added in `/Training/evals`.
